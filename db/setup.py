...
connect = sqlite3.connect('/etc/relayctl/db/relayctl.db')
cursor = connect.cursor()

cursor.execute("CREATE TABLE relays(id INTEGER PRIMARY KEY AUTOINCREMENT, gpio INT NOT NULL)")
cursor.execute("CREATE TABLE switches(id INTEGER PRIMARY KEY AUTOINCREMENT, gpio INT NOT NULL, relay_id INT NOT NULL, action INT NOT NULL)")
