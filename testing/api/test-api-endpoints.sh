...
do
	case "$end_point" in
		schedule*)
			payload="{\"name\": \"testing\", \"start_time\": \"00:00:00\", \"end_time\": \"00:10:00\", \"days\": \"1 2 3 4 5 6 7\", \"relay_index\": \"0\", \"action\": \"on\"}"
		;;
		switches*)
			payload="{\"name\": \"testing\", \"input_index\": \"0\", \"relay_index\": \"0\", \"mode\": \"on\"}"
		;;
	esac
